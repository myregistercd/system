...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">';
    ...
    function Dlsearch($details = false, $shape = '', $option = '', $ispremium = false, $settingsid = '') {
        $data = $this->getCommonData();
        $data ['title'] = 'Diamonds';
        $shapearray = array(
            'B',
...
diamond anniversary band, diamond bridal sets, diamond solitaire pendant, blue diamond jewelry. Purchase discounted rate diamond anniversary band, diamond bridal sets, diamond solitaire pendant,  blue diamond jewelry">
	...
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">';
            ...
            $output = $this->load->view('diamond/bomiadvancesearch', $data, true);
...
{
$all_pro = $this->commonmodel->select_where('*','dev_rapproduct',array('Fancy_Color'=>$color));
print $all_pro; exit;
}
...
//exit();
    ...
    function diamonddetails($lot, $addoption = '', $settingsid = '') {
        ...
        $date ['nexturl'] = '';
		$price = ($details['price'] > 0) ? $details['price'] : 0; // added for add to cart issue 
        switch ($addoption) {
