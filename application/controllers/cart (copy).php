	...
	function addtocart($addoption = '', $lot= '', $sidestone1 = '', $sidestone2 = '', $stockno = '',$price = '',$dsize = ''){
		...
		switch ($addoption){
			case 'addloosediamond':
				...
				if($success == 'exist') $msg = '<table width="100%" align="center"><tr><td width = "60"><img src="'.config_item('base_url').'/images/worning.gif"></td><td>You have already added this product!</td></tr>  </table>';
